// ==UserScript==
// @name         Alchemy Simulator
// @namespace    http://tampermonkey.net/
// @version      v18.4
// @description  Thins a Alchemy Simulator
...
// @require      https://update.greasyfork.org/scripts/541288/1617559/alchemy-calculator%20v12%20EN.js
// @require      https://update.greasyfork.org/scripts/541211/1617022/alchemy-data%20v10.js
// @grant        GM_addStyle
// @downloadURL https://update.greasyfork.org/scripts/541293/Alchemy%20Simulator.user.js
// @updateURL https://update.greasyfork.org/scripts/541293/Alchemy%20Simulator.meta.js
// ==/UserScript==
...
.ui-state-focus {
    ...
    function insertSimulatorTab(currentActionTab) {
        ...
        if (badgeSpan) {
            badgeSpan.textContent = 'Alchemy Simulator';
            // 清空徽章内容
    ...
    function openAlchemySimulator() {
        // 如果已经存在模态框，则不再创建
        if (document.querySelector('.alchemy-simulator-modal')) return;
        ...
        title.textContent = 'Alchemy Simulator By MapleRedbean';
        ...
        <div class="container">
            ...
            <div class="price-selector">
                ...
                <div class="catalyst-selector">
                    <label>Catalyst selection：</label>
            ...
            <div class="input-row">
                <div class="control-group">
                    ...
                    <div class="autocomplete"><input class="alchemy-text" type="text" value="Sunstone"></div>
                </div>
                <div class="control-group">
                ...
                <div class="control-group">
                    <label for="simulateTimes">Simulation times</label>
            ...
            <div class="input-row">
                <div class="control-group">
                    <label for="itemPrice">Cost item price</label>
                    <input type="number" id="itemPrice" placeholder="金币" value="0" readonly>
                </div>
                <div class="control-group">
                    <label for="Catalyst">Catalyst price</label>
                ...
                <div class="control-group">
                    <label for="Catalyst">Once Cions</label>
                    <input type="number" id="allcostPerTry" placeholder="金币" value="0" readonly>
                </div>
                <div class="control-group">
                    <label for="timePerTry">single time(s)</label>
            ...
            <table class="output-table">
                <thead>
                    <tr>
                        <th>Transformation products</th>
                        <th style="width: 15%;">Probability (%)</th>
                        <th style="width: 20%;">Price</th>
                        <th style="width: 25%;">Drop Quantity / Yield Amount</th>
                        <th>total price</th>
                    </tr>
                </thead>
            ...
            <div style="text-align: center;">
                <button class="btn" id="startBtn">Start Alchemy</button>
                <button class="btn" id="refreshPricesBtn" style="margin-left: 10px; background: linear-gradient(135deg, #006400, #228B22);">Refresh Price First</button>
                <button class="btn" id="addItemBtn" style="margin-left: 10px; background: linear-gradient(135deg, #4a148c, #7b1fa2);">None</button>
            </div>
